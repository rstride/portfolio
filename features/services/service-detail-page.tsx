            ...
            <div className="space-y-6">
              ...
              <Card className="surface-contrast overflow-hidden">
                ...
                <CardContent className="flex flex-col gap-4">
                  ...
                  <Link
                    href="/contact"
                    className="inline-flex h-11 items-center justify-center gap-2 rounded-full bg-[linear-gradient(135deg,var(--primary),var(--brand-secondary))] px-6 text-sm font-medium text-primary-foreground shadow-[0_14px_30px_rgba(22,126,102,0.2)] transition hover:opacity-95"
                  >
