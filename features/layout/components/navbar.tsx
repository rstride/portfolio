...
const navShellClass =
  "relative w-full rounded-[1.35rem] border border-white/10 bg-[rgba(10,18,20,0.86)] px-3 py-2 shadow-[0_14px_34px_rgba(6,18,18,0.22)] backdrop-blur-xl";

const submenuSurfaceClass =
  "overflow-hidden rounded-[1rem] border border-white/10 bg-[rgba(10,18,20,0.96)] shadow-[0_18px_40px_rgba(6,18,18,0.28)] backdrop-blur-xl";
...
const serviceCardClass = (active: boolean) =>
  cn(
    ...
    active ? "bg-white/8 text-foreground" : "text-foreground hover:bg-white/6"
  );
    ...
    <header className="fixed inset-x-0 top-0 z-50 px-4 pt-2 sm:px-6 sm:pt-3 lg:px-8">
      ...
      <div className="mx-auto max-w-7xl">
        <div className={navShellClass}>
          ...
          <div className="pointer-events-none absolute right-5 top-0 h-10 w-20 bg-[radial-gradient(circle_at_top,rgba(80,220,255,0.1),transparent_72%)]" />

          <div className="relative flex h-14 items-center gap-3">
            <Link href="/" className="flex shrink-0 items-center gap-3 pr-4">
              <span className="flex size-9 items-center justify-center rounded-[0.9rem] bg-[linear-gradient(135deg,var(--primary),var(--brand-secondary))] text-[11px] font-semibold uppercase tracking-[0.14em] text-primary-foreground shadow-[0_8px_20px_rgba(22,126,102,0.18)]">
                RS
              </span>
            ...
            <div className="ml-auto flex items-center gap-3 pr-2">
              ...
              <Sheet open={open} onOpenChange={setOpen}>
                ...
                <SheetContent
                  ...
                  className="border-b border-white/10 bg-[rgba(8,16,18,0.96)] px-0 pt-16 backdrop-blur-xl md:hidden"
                >
                  ...
                  <div className="px-4 pb-6 sm:px-6">
                    <div className="rounded-[1.4rem] border border-white/10 bg-[rgba(10,18,20,0.9)] p-4 shadow-[0_18px_40px_rgba(6,18,18,0.28)]">
