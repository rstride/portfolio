...
export function Hero() {
  ...
  return (
    <section className="relative flex min-h-[calc(100vh-5rem)] items-start overflow-hidden pt-6 lg:pt-8">
      ...
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_18%_24%,rgba(186,76,255,0.14),transparent_30%),radial-gradient(circle_at_82%_70%,rgba(80,220,255,0.1),transparent_26%),linear-gradient(180deg,rgba(12,11,27,0.86),rgba(12,11,27,0.96))]" />
      ...
      <div className="container relative z-10 mx-auto px-4 pb-10 pt-4 lg:pb-16 lg:pt-6">
        <div className="grid gap-16 lg:grid-cols-[minmax(0,1.05fr)_0.95fr] lg:items-center">
          <motion.div {...landingReveal} className="flex flex-col gap-8 text-left lg:pr-6">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                ...
                className={cn(
                  ...
                  "group border-0 bg-[linear-gradient(135deg,var(--primary),var(--brand-secondary))] text-primary-foreground shadow-[0_16px_34px_rgba(110,92,255,0.28)]"
                )}
                onClick={() =>
                  queue
          ...
          >
            <div className="relative mx-auto aspect-[1.05] w-full max-w-[32rem]">
              <div className="absolute inset-0 rounded-[2.5rem] border border-white/6 bg-[radial-gradient(circle_at_top,rgba(186,76,255,0.12),transparent_42%)]" />
              <div className="absolute right-[8%] top-[15%] size-[22rem] rounded-full border border-primary/20" />
              <div className="absolute right-[8%] top-[15%] size-[22rem] rounded-full border border-brand-secondary/14 scale-[1.08]" />
              <div className="absolute right-[8%] top-[15%] size-[22rem] rounded-full border border-primary/12 scale-[1.16]" />
              ...
              <div className="absolute right-[8%] top-[15%] size-[22rem] overflow-hidden rounded-full border border-white/10 bg-card shadow-[0_28px_80px_rgba(10,8,24,0.34)]">
                ...
                <Image src="/romain.png" alt={`Portrait de ${site.name}`} fill className="object-cover" priority />
              </div>
              ...
              <div className="absolute bottom-[4%] right-[20%] rounded-full border border-border/60 bg-background/65 px-4 py-2 text-xs font-medium tracking-[0.2em] text-muted-foreground uppercase backdrop-blur">
