...
import { ArrowRight, CheckCircle2, GraduationCap, Search, Shield, Target } from "lucide-react";
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 pb-18 pt-6 sm:px-6 lg:px-8 lg:pb-24 lg:pt-10">
                  ...
                  <Card className="surface-panel flex h-full flex-col overflow-hidden">
                    ...
                    <CardContent className="flex flex-1 flex-col gap-5">
                      ...
                      <Link
                        ...
                        className={cn(buttonVariants({ variant: "ghost" }), "mt-auto justify-start px-0 text-foreground hover:bg-transparent")}
                      >
                        Voir le détail
        ...
        <motion.section
          {...landingReveal}
          transition={{ ...landingReveal.transition, delay: 0.18 }}
          className="mt-8"
        >
