                ...
                <div key={service.slug} className="surface-subtle p-4">
                  <div className="flex items-center justify-between gap-3">
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-relaxed text-muted-foreground">{service.outcome}</p>
                    </div>
          ...
          {site.services.map((service, index) => {
            ...
            return (
              <motion.div
                key={service.slug}
                {...landingReveal}
                transition={{ ...landingReveal.transition, delay: 0.1 + index * 0.06 }}
              >
                <Card className="surface-panel overflow-hidden">
                  <CardContent className="grid gap-5 p-6 md:grid-cols-[1fr_0.92fr]">
                    ...
                    <div className="grid gap-3">
                      ...
                      <div className="surface-tint p-4">
                        <p className="text-[10px] uppercase tracking-[0.2em] text-primary">Idéal pour</p>
                  ...
                  <CardFooter className="border-t border-border/60 px-6 pb-6 pt-4">
                    <Link
                      ...
                      className={cn(buttonVariants({ variant: "ghost" }), "px-0 text-foreground hover:bg-transparent")}
                    >
                      Voir le détail
