...
export function Footer() {
  ...
  return (
    <footer className="bg-[#0c0e12] flex flex-col md:flex-row justify-between items-center w-full px-6 md:px-8 py-6 border-t border-outline-variant/20 relative z-10 mt-auto">
      <div className="font-mono text-[10px] tracking-widest text-on-surface/40 uppercase mb-4 md:mb-0">
