...
export function BackgroundEffects({
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <motion.div
        className="absolute inset-x-0 top-0 h-72 bg-[radial-gradient(circle_at_top,rgba(36,184,122,0.18),transparent_62%)]"
      ...
      {variant !== "section" ? (
        <motion.div
          className="absolute left-[-8rem] bottom-[-2rem] h-60 w-60 rounded-full bg-[radial-gradient(circle,rgba(36,184,122,0.14),transparent_68%)] blur-3xl"
