...
export default function Home() {
  return (
    ...
    >
      ...
      <StructuredData data={professionalServiceJsonLd('fr')} />
          ...
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-12 xl:gap-16 items-end">
            <div className="xl:col-span-7 2xl:col-span-8">
              <h1 className="font-headline text-5xl md:text-7xl lg:text-8xl 2xl:text-[7.5rem] font-bold uppercase tracking-tighter leading-[0.9] text-on-surface mb-8 2xl:mb-10">
                CONSULTANT <br />
                <span className="text-secondary">CYBERSÉCURITÉ</span> <br />
              </h1>

              <p className="text-lg md:text-xl text-on-surface-variant leading-relaxed max-w-2xl mb-12 font-light">
                Consultant cybersécurité freelance pour pentests applicatifs, audits API et cloud, formations sécurité et accompagnement offensif : transformez les risques techniques en actions concrètes, priorisées et directement exploitables.
              </p>

              <div className="flex flex-wrap gap-4">
                <Link href="/contact?source=home_hero" className="cta-primary inline-flex text-sm px-8 py-4">
                  Demander un cadrage
                </Link>
                <Link href="/services" className="cta-secondary inline-flex text-sm px-8 py-4">
                  Voir les services
                </Link>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 relative">
              <div className="mx-auto max-w-[14rem] sm:max-w-xs md:max-w-sm lg:max-w-sm aspect-[4/5] sm:aspect-[3/4] bg-surface-container-highest border border-outline-variant/20 relative p-2">
                ...
                <div className="w-full h-full border border-primary/10 relative overflow-hidden contrast-125 opacity-80">
                  <Image
                    src="/rstride.jpg"
                    alt="Portrait de Romain Stride, consultant cybersécurité et pentester freelance"
                    fill
        ...
        <div className="relative z-10 hero-frame">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-surface-container p-1 inline-flex flex-col sm:flex-row items-center gap-4 border border-outline-variant/20">
              ...
              <Link href="/contact?source=home_final_cta" className="cta-primary inline-flex text-sm px-8 py-4 w-full sm:w-auto">
                CONTACTEZ-MOI
              </Link>
            </div>
          </div>
