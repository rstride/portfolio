      ...
      <header className="mb-20 xl:mb-24">
        <div className="max-w-4xl">
          ...
          <p className="max-w-3xl text-on-surface-variant text-lg leading-relaxed font-light">
            Missions offensives ciblées, pentests web, audits API/cloud et formats de formation conçus pour produire des résultats utilisables.
            L&apos;objectif: valider les surfaces réellement exploitables et transmettre des méthodes défensives qui tiennent au terrain.
          </p>
        </div>
      </header>
          ...
          {auditServices.map((service) => {
            ...
            return (
              ...
              >
                ...
                <Link href={`/contact?service=${service.slug}&source=services`} className="services-simple-cta">
          ...
          {trainingPrograms.map((program) => {
            ...
            return (
              ...
              >
                ...
                <Link href={`/contact?service=${program.slug}&source=services`} className="services-simple-cta">
