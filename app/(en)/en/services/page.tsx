      ...
      <header className="mb-20 xl:mb-24">
        <div className="max-w-4xl">
          ...
          <p className="max-w-3xl text-on-surface-variant text-lg leading-relaxed font-light">
            Targeted offensive engagements, web pentests, API/cloud audits, and training formats built to produce usable outcomes. The goal:
            validate what is actually exploitable and transfer defensive methods that hold up in the field.
          </p>
        </div>
      </header>
