...
export const metadata = { title: "Sensibilisation à la cybersécurité" };

export default function SensibilisationPage() {
  const data = site.servicePages["sensibilisation"];
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-3xl font-bold tracking-tight">Sensibilisation à la cybersécurité</h1>
