...
export const metadata = { title: "Formation aux fondamentaux de l’IA" };

export default function FormationIAPage() {
  const data = site.servicePages["formation-ia"];
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-3xl font-bold tracking-tight">Formation aux fondamentaux de l’IA</h1>
